<?php
	...
	connect();
$sql1="SELECT Course_Department FROM course";
$query1=mysql_query($sql1);
/*while($result=mysql_fetch_array($query1)){
	echo'Course Department="'.$result['Course_Department'].'"';	
	
}*/
echo'
	<div id="addnewelement">
		<div id="action_header">
			<label class="labelstyle">Create Class Timetable</label>
		</div>
		<span style="display:none; position:fixed; top:40%; left:48%;" id="AlertSpanTimetable"></span>
		<form>
		...
		<tr>
			...
			<td class="table_padding_top">
				<select id="coursedepartment" onchange="getcourse(this)">
		...
		<tr>
			...
			<td>Unit</td>
			<td>
				<input class="input-large" id="txtUnit" type="text" placeholder="Start Typing Unit Code..." data-provide="typeahead">
			</td>
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			<td></td>
			<td>Lecturer Name</td>
			<td><input type="text" placeholder="Type Lecturer Name" id="txtLecturersname"></td>
		</tr>
		<tr>
			<td></td>
			<td></td>
			<td class="table_padding_bottom"><button class="btn btn-success" type="submit" onClick="savetimetable()">Save Timetable</button>
			<button class="btn" type="reset" id="cleartable">Cancel</button></td>
