	...
	if($result=mysql_num_rows($query)>1){
		...
		while($arrays=mysql_fetch_array($query)){
			...
			echo '
						...
						<tr class="mousetopointer noticehover" id="'.$arrays['Exam_Id'].'" onclick="editTable(this)" width="60%" align="center" style="padding:10px;" rel="tooltip" 	title="click to edit">
						<td width="5%" align="center">'.$arrays['Exam_Day'].'</td>
