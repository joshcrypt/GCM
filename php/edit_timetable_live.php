...
if(isset($_POST['save_edit_id']) && isset($_POST['edit_exam_coursedepartment']) && isset($_POST['edit_exam_drpcourse']) && isset($_POST['edit_exam_yearofstudy']) && isset($_POST['edit_exam_day']) && isset($_POST['edit_exam_starttime']) && isset($_POST['edit_exam_endtime']) && isset($_POST['edit_exam_txtUnit']) && isset($_POST['edit_exam_drpVenue']) && isset($_POST['edit_exam_days_int'])){
	...
	$edit_exam_days_int = $_POST['edit_exam_days_int'];
	
	//Department,Course_Name,Start_Time,Stop_Time,Day,Unit_Name,Year,Venue,Exam_Day
	//UPDATE  `ttucinfodroid`.`exam_timetable` SET  `Department` =  'Mthematics And Informatics' WHERE  `exam_timetable`.`Exam_Id` =4;
	
	include_once('dbconnection.php');
	connect();
	
	$sql = "UPDATE exam_timetable SET Department='".$edit_exam_coursedepartment."',Course_Name='".$edit_exam_drpcourse."',Start_Time='".$edit_exam_starttime."',Stop_Time='".$edit_exam_endtime."',Day='".$edit_exam_day."',Unit_Name='".$edit_exam_txtUnit."',Year='".$edit_exam_yearofstudy."',Venue='".$edit_exam_drpVenue."',Exam_Day='".$edit_exam_days_int."' WHERE Exam_Id='$save_edit_id'";
