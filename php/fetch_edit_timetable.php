...
if(isset($_POST['idtable'])){
	...
	$sql="SELECT * FROM exam_timetable WHERE Exam_Id='$idtable' ";
		...
		echo '<div class="modal-header edit_title">
				...
				<table>
					...
					<tr>
						...
						<td>Exam Day</td>
						<td><input type="text" placeholder="Type Day e.g. Day 1" id="edit_exam_days_int"></td>
					</tr>
					<tr>
						
						<td></td>
						<td class="table_padding_bottom"><button class="btn btn-success" id="'.$array['Exam_Id'].'" type="submit" onClick="save_edit_examtimetable(this)">Save Timetable</button>
